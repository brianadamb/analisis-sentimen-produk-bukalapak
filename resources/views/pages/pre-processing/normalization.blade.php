        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card p-6">
                    ...
                    <form action="{{url('pre_processing/normalization')}}" method="GET">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-12 col-md-3 mb-1 mt-8">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="/pre_processing/normalization" class="btn btn-secondary btn-md w-100">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </div>
