...
<script src="assets/js/custom/pages/merchant/list.js"></script> -->
<!-- <script src="assets/js/custom/pages/merchant/modal.js"></script> -->
...
<script type="text/javascript">
    function deleteConfirmation(id) {
        swal.fire({
            ...
            //
            if (e.isConfirmed) {
                console.log("{{ url ('merchant/delete/')}}" + "/" + id);
                    ...
                    <table id="kt_datatable_example_2" class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                     <a href="#" style="color: #7E8299;pointer-events: none;cursor: default;" title="{{$item->user_toko}}">
                                        {{mb_strimwidth($item->user_toko, 0, 30, "...")}}
                                    </a>
