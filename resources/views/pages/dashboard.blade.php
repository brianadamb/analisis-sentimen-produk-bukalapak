	...
	<div class="post d-flex flex-column-fluid" id="kt_post">
		...
		<div id="kt_content_container" class="container-xxl">
			...
			<div class="row g-5 g-xl-8">
						...
						<div class="card-body p-6">
							<div class="d-flex flex-stack card-p flex-grow-1">
								<span class="symbol symbol-100px">
									...
									<span class="svg-icon svg-icon-4x svg-icon-white ms-n1">
								...
								<div class="d-flex flex-column text-end">
									<span class="text-white fw-bolder fs-1">256</span>
									<span class="text-white fw-bolder fs-2">Product Stored</span>
								</div>
							</div>
						</div>
						<!--end::Body-->
					...
					<div class="card bg-primary card-xl-stretch mb-xl-8">
						...
						<div class="card-body p-6">
							<div class="d-flex flex-stack card-p flex-grow-1">
								...
								<div class="d-flex flex-column text-end">
									<span class="text-white fw-bolder fs-1">25</span>
									<span class="text-white fw-bolder fs-2">Merchant Joined</span>
								</div>
							</div>
						</div>
						<!--end::Body-->
				...
				<div class="col-xl-4">
					<!--begin::Statistics Widget 4-->
					<div class="card bg-success card-xl-stretch mb-xl-8 mb-5">
						<!--begin::Body-->
						<div class="card-body p-6">
							<div class="d-flex flex-stack card-p flex-grow-1">
								<span class="symbol symbol-100px">
								...
								<div class="d-flex flex-column text-end">
									<span class="text-white fw-bolder fs-1">25</span>
									<span class="text-white fw-bolder fs-2">Sales Review</span>
								</div>
							</div>
						</div>
						<!--end::Body-->
